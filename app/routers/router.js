...
router.put('/api/genre/', genres.updateGenre);
...
router.put('/api/author', authors.updateAuthor);
...
router.put('/api/translator', translators.updateTranslator);
...
router.put('/api/book', books.updateBook);
